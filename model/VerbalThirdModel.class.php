 ...
 * 三道题的阅读题
 */
class VerbalThirdModel {

    private $db;
    private $table = 'verbal_reading_third';
    ...
    public function getVerbalThirdById ($qid) {
        $sql = "SELECT `article`, `question1` as `question`, `choices1` as `choices`, `q1type` as `qtype`, `answer1` as `answer`, `explain1` as `explain`, `question2`, `choices2`, `q2type`, `answer2`, `explain2`, `question3`, `choices3`, `q3type`, `answer3`, `explain3` from `". $this->table. "` where `qid`='". $qid. "'";
        $data = $this->db->getData($sql);
