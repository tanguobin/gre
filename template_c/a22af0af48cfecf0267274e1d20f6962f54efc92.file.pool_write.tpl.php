<?php /* Smarty version Smarty3-RC3, created on 2014-02-13 21:31:22
         compiled from "/var/grer/template/web/pool_write.tpl" */ ?>
<?php /*%%SmartyHeaderCode:38300840852fcc92ab3fcd6-57241234%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a22af0af48cfecf0267274e1d20f6962f54efc92' => 
    array (
      0 => '/var/grer/template/web/pool_write.tpl',
      1 => 1371479562,
    ),
  ...
  'nocache_hash' => '38300840852fcc92ab3fcd6-57241234',
  'function' => 
  array (
  ),
...
<html>
    <head>
        ...
        <title>爱GRE模考网(igrer.com) - <?php echo $_smarty_tpl->getVariable('article')->value['title'];?>
</title>
        ...
        <meta name="description" content="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('article')->value['title']);?>
 - <?php echo smarty_modifier_escape($_smarty_tpl->getVariable('article')->value['question']);?>
" />
...
<?php $_template = new Smarty_Internal_Template("lib/modules/writing.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
<?php if ($_smarty_tpl->getVariable('article')->value['id']<$_smarty_tpl->getVariable('maxId')->value){?>
<div class="fr next cf"><a id="J_next" class="login-btn" href="/<?php echo $_smarty_tpl->getVariable('article')->value['type'];?>
/<?php echo $_smarty_tpl->getVariable('article')->value['id']+1;?>
">下一题</a></div>
<?php }?>
<script type="text/javascript">
var uyan_config = {
